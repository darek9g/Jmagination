 ...
 */
public class OperationTwoImagesLogicXOR extends OperationTwoImagesAbstract {

    {
        label = "Logiczna wyłączna alternatywa";
        header = "Logiczna wyłączna alternatywa";
        description = "Nadanie wynikowym pikselom wartości" + BR + "XOR bitów odpowiadających sobie pikesli z dwóch obrazów.";
