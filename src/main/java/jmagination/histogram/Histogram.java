...
public class Histogram {
    ...
    public Histogram(SimpleHSVBufferedImage img) {
        ...
        data = new ArrayList<Integer[]>(bands);
    ...
    private void update() {
        ...
        PixelHood<int[]> pixelHood = new PixelHood<int[]>(0,0, new int[raster.getNumBands()]);
...
//                    System.out.printf("Level:Value %d:%d\n", barX, series[level]);
    ...
    public SimpleHSVBufferedImage drawImg2(int histImageWidth, int histImageHeight, int mariginLeft, int mariginRight,int mariginTop, int mariginBottom) {
        ...
        for(int level = 0; level < seriesLength; ++level) {
            ...
            ArrayList<ColorStrip> bar = new ArrayList<ColorStrip>();
